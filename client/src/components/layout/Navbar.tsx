...
export function Navbar() {
  const { isConnected, formattedAddress, balance, connect, disconnect } = useWeb3Mock();
      ...
      <div className="px-4 sm:px-6 lg:px-12">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            >
              <button className={`flex items-center gap-1 text-[15px] font-semibold transition-all duration-200 ${
                activeMenu === 'trade' || isTradeActive ? 'text-white' : 'text-[#a1a1aa] hover:text-white'
              }`}>
            ...
            >
              <button className={`flex items-center gap-1 text-[15px] font-semibold transition-all duration-200 ${
                activeMenu === 'explore' || isExploreActive ? 'text-white' : 'text-[#a1a1aa] hover:text-white'
              }`}>
            ...
            >
              <button className={`flex items-center gap-1 text-[15px] font-semibold transition-all duration-200 ${
                activeMenu === 'staking' || isStakingActive ? 'text-white' : 'text-[#a1a1aa] hover:text-white'
              }`}>
            ...
            {isConnected ? (
              ...
              <div className="relative">
                <Button 
                  ...
                  className={`relative group h-10 px-6 font-bold transition-all duration-300 overflow-hidden ${
                    isWalletPopoverOpen 
